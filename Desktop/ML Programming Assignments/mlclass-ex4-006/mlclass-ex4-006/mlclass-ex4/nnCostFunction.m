...
regularizationTerm = (lambda/(2*m)) *sum((Theta1(:,2:end).^2)(:));
regularizationTerm1 = (lambda/(2*m)) * sum((Theta2(:,2:end).^2)(:));
J = (1/m)*sum((-y.*log(a3) - (1-y).*log(1-a3))(:)) + regularizationTerm+regularizationTerm1
%for i=1:m
D3 = a3-y;
